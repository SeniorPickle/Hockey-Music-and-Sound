...
class Album():
    ...
    def open_album(self, what=None):
        ...
        music_add_box = toga.Box(style=Pack(background_color="#000000"))
        music_back_button = toga.Button("X", style=Pack(text_align=LEFT, font_size=10, padding=(5, 0, 5, 20)),on_press=self.app.main_page)
        music_add_label = toga.Label(self.formal_name, style=Pack(flex=1, background_color="#000000", color="#ffffff",text_align=CENTER, font_size=20))
